...
REM
REM jhove2_upfg.sh - Class to generate editable Java properties file for units of 
REM measusre settings for Reportable features that have a Numeric type
REM
REM USAGE:  java -cp CLASSPATH org.jhove2.app.util.UnitsPropertyFileGenerator fully-qualified-class-name output-dir-path
REM
